...
export default function ContactsPage() {
  ...
  const stats = {
    ...
    responded: contacts.filter((c: any) => c.status === "responded").length,
  };
          ...
          <Table>
            ...
            <TableBody>
              {filteredContacts.map((contact: any) => (
                <TableRow key={contact._id} className="hover:bg-green-50/50">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-lg">{selectedContact.fullName}</p>
                </div>
                <div>
                  <p className="text-sm font-semibold text-gray-600 mb-1">
                    Email
